...
import { mockedSearchInputDefault, mockedSearchInputSmall, mockedSearchInputLarge, mockedSearchInputWithValue, mockedSearchInputInvalid } from './searchInputMock';
