...
import { mockedProductDetailsDefault, mockedProductDetailsDetailed, mockedProductDetailsMinimal, mockedProductDetailsWithNumbers, mockedProductDetailsLongValues } from './productDetailsMock';
